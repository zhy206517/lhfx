...
public class Weibo {
    ...
    public static String URL_ATTIONUSER		= "http://api.t.sina.com.cn/friendships/create.json";
	
	public static String URL_GET_NEAR_PLACE = "http://api.weibo.com/place/nearby/pois.json";
    
	public static String APP_KEY = "589750322";//837378871
	public static String APP_SECRET = "625010f32da1d30d2646d7072143f27d";//eead7b50ef53f056daf08996d0ccabb9
...
//    }
	...
	public void follow(Context context, String userId) throws WeiboException{
		WeiboParameters postParams = new WeiboParameters();
		postParams.add("source", APP_KEY);
		postParams.add("user_id", userId);
		request(context, URL_ATTIONUSER, postParams, "POST", null);
//		System.out.println(result);
	}
	
	public void getNearPlaces(Context context) throws WeiboException{
		WeiboParameters postParams = new WeiboParameters();
		postParams.add("source", APP_KEY);
		postParams.add("lat", "40");
		postParams.add("long", "116");
		String result = request(context, URL_GET_NEAR_PLACE, postParams, "POST", null);
