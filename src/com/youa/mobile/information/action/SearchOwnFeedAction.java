...
import com.youa.mobile.information.action.SearchOwnFeedAction.SearchOwnFeedResult;
...
public class SearchOwnFeedAction extends BaseAction<SearchOwnFeedResult> {
	...
	public interface SearchOwnFeedResult extends IResultListener, IFailListener {
		public void onStart();
	...
	protected void onExecute(Context context, Map<String, Object> params,
			SearchOwnFeedResult resultListener) throws Exception {
		...
		List<HomeData> feedList = new PersonalInfoManager().searchOwnFeedList(
				context, uid, currentPageIndex); // 发出联网处理
