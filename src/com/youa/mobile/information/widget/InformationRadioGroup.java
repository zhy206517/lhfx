...
package com.youa.mobile.information.widget;
 ...
 *
 */
public class InformationRadioGroup extends LinearLayout {
	public static final String TAG = "InformationRadioGroup";
     ...
     * {@inheritDoc}
     */
    public InformationRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public InformationRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof LinearLayout
            ...
            final RadioButton button = 
            	(RadioButton) ((LinearLayout)child).getChildAt(0);
...
//    }
    ...
    public interface OnCheckedChangeListener {
		...
		public void onCheckedChanged(
				InformationRadioGroup informationRadioGroup, int checkedId);
    }
    ...
    private class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
             ...
             if(isChecked) {
             	parentView.setBackgroundResource(R.drawable.information_header_tab_white_bg);
             } else {
             	parentView.setBackgroundResource(R.drawable.information_header_tab_bg);
             }
    ...
    private class PassThroughHierarchyChangeListener implements
         ...
         * {@inheritDoc}
         */
        public void onChildViewAdded(View parent, View childParent) {
            if (parent == InformationRadioGroup.this 
            		&& childParent instanceof LinearLayout) {
            	View child = ((LinearLayout)childParent).getChildAt(0);
                int id = child.getId();
...
//                        mChildOnCheckedChangeListener);
         ...
         * {@inheritDoc}
         */
        public void onChildViewRemoved(View parent, View childParent) {
            if (parent == InformationRadioGroup.this 
            		&& childParent instanceof LinearLayout) {
            	View child = ((LinearLayout)childParent).getChildAt(0);
