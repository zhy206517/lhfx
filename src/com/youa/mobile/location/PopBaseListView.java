...
public abstract class PopBaseListView<H extends BaseHolder, L extends List<?>> {
	...
	public PopBaseListView(ListView listView, View header, View footer) {
...
//	}
	...
	protected abstract View createTemplateView(int position);
...
//			holder = (H) convertView.getTag(HOLDER_KEY);
			/*if (showViewId > 0 && hideViewId > 0) {
				View hideView = convertView.findViewById(hideViewId);
				if (null != hideView) {
					hideView.setVisibility(View.GONE);
				}
				View showView = convertView.findViewById(showViewId);
				if (null != showView) {
					showView.setVisibility(View.VISIBLE);
				}
			}*/
			convertView.setTag(currentId + ":" + position);
			setDataWithHolder(holder, position, PopBaseListView.this.mIsMoveing);
			return convertView;
		}

//		public final H getHolderByPosition(int position) {
//			H holder = null;
//			View currentView = mListView.findViewWithTag(currentId + ":"
//					+ position);
//			if (currentView == null) {
//				return null;
//			}
...
//		}
		...
		/*public void hideShowView(int hideViewId, int showViewId) {
