 ...
 *
 */
public class NewsTitleRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public NewsTitleRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public NewsTitleRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RelativeLayout
            ...
            final RadioButton button = 
            	(RadioButton) ((RelativeLayout)child).getChildAt(0);
...
//    }
    ...
    public interface OnCheckedChangeListener {
		...
		public void onCheckedChanged(
				NewsTitleRadioGroup informationRadioGroup, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View childParent) {
            if (parent == NewsTitleRadioGroup.this 
            		&& childParent instanceof RelativeLayout) {
            	View child = ((RelativeLayout)childParent).getChildAt(0);
                int id = child.getId();
