...
import com.youa.mobile.utils.BeanUtils;
...
public class LehoProgressDialog extends AlertDialog {
    
    public static final int STYLE_SPINNER = 0;
    
    /** Creates a LehoProgressDialog with a horizontal progress bar.
     */
	...
	public LehoProgressDialog(Context context) {
    	this(context, android.R.style.Theme_Panel);
    	mContext = context;
    }

    public LehoProgressDialog(Context context, int theme) {
        super(context, theme);
    }

    public static LehoProgressDialog show(Context context, CharSequence title,
    ...
    public static LehoProgressDialog show(Context context, CharSequence title,
        ...
        LehoProgressDialog dialog = new LehoProgressDialog(context);
    ...
    private LinearLayout initLayout()
    {
    	...
    	layout_message_h.setPadding(0, 20, 0, 0);
