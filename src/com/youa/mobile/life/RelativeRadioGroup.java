 ...
 *
 */
public class RelativeRadioGroup extends LinearLayout {
...
//						Toast.makeText(getContext(), R.string.life_wait_for_open, Toast.LENGTH_SHORT).show();
					}
				}            	
            });
            if (button.isChecked()) {
...
//    }
    ...
    public interface OnCheckedChangeListener {
		...
		public void onCheckedChanged(
				RelativeRadioGroup informationRadioGroup, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View childParent) {
            if (parent == RelativeRadioGroup.this 
